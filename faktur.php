...
<div class="lebar-100persen tinggi-600px   kiri" align="center">
    ...
    <div class="kiri jarak-atas-05persen lebar-100persen font-hitam  padding-atas-1persen  padding-bawah-1persen  font-ukuran-22 font1 font-bold font-abu">
    	Faktur Transaksi
    </div>
            	...
            	<?php
				  ...
				  ?>
                         <div class="kiri lebar-30persen tinggi-480px jarak-kiri-1persen   garis-kanan-1abu garis-kiri-1abu garis-atas-1abu garis-bawah-1abu garis-bayang-abu2 padding-kanan-1persen  padding-kiri-1persen" align="left">
                                    ...
                                    <br />
                                    <p class="font1 font-bold font-ukuran-18 font-hitam" align="left"><?php echo $datakantong['nama_barang'];?></p>
                                    <br />
                                    <hr size="1" color="#BBBBBB" />
                                    <br />
                                    <p class="font1 font-bold font-ukuran-18 font-merah" align="left">
                                        Harga Barang : Rp. <?php echo number_format($subtotal=$datakantong['hrg_barang'],0,'','.');?>
                                    </p>
                                    <br />
                                    
                                    <hr size="1" color="#BBBBBB" />
                                    <br />
                                    <p align="left" class="font1 font-bold font-ukuran-18 font-hitam">
                                    ...
                                    <p align="left" class="font1 font-bold font-ukuran-20 font-merah">
                                        Total Harga Barang : <?php echo number_format($subtotal=$datakantong['hrg_barang']*$datakantong['jumlah'],0,'','.');?>
                                    </p>
                                    <br />
         ...
         <br>
            ...
            <form action="penyewaan_simpan.php" method="post" enctype="multipart/form-data">
                ...
                <div class="kiri lebar-45persen jarak-kiri-2persen putihabu padding-kiri-2persen garis-bayang-abu2 garis-kiri-1abu garis-kanan-1abu garis-atas-1abu garis-bawah-1abu">
                    ...
                    <br />
                    <p class="font-ukuran-14">
                        Pembayaran Via Transfer Bank:
                        <br><br>
                       	
                       	Bank BCA : a/n  Fidaus 6837374747
                        
                        <br><br>
                        
                        <input name="print" type="button" id="Batal" value="CETAK BUKTI FAKTUR" class="biru kanan jarak-bawah-05persen jarak-kanan-05persen" title="cetak bukti faktur" 
                          onClick="window.open('faktur_print.php?id=<?php echo $_GET['id']; ?>',
                          'resizable=yes,top=200,left=350,width=800,height=900');"  />
                    </p>
                    <br />
                    <br />
                </div>
