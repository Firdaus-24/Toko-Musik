 <div class="lebar-95persen kiri garis-atas-1hitam garis-kanan-1hitam garis-kiri-1hitam garis-bawah-1hitam rounded-atas-kanan-1 rounded-atas-kiri-1 rounded-bawah-kanan-1 rounded-bawah-kiri-1 jarak-kiri-2persen jarak-atas-1persen hitam">
        ...
        <div class="lebar-100persen tinggi-40px kiri">
        	<a href="index.php?hal=kotatambah">
        	<input type="submit" value="Tambah kota" 
        ...
        <table width="98%" border="1" cellpadding="2" cellspacing="2" class="jarak-atas-1persen jarak-kiri-1persen kiri font-besar">
        	<tr bgcolor="#CCCCCC">
                ...
                <td align="center" width="254">nama kota</td>
                <td width="401" align="center">ongkir</td>
                <td width="193" align="center">Aksi</td>
            </tr>
            <?php
				include'../../koneksi/koneksi.php';
				$no=1;
				$sql=mysql_query("select*from kota order by id_kota desc");
            ...
            <tr bgcolor="<?php echo $warna; ?>">
                ...
                <td align="center"><?php echo $data['nama_kota']; ?></td>
                <td align="center"><?php echo $data['ongkos_kirim']; ?></td>
                <td align="center">
                <a href="index.php?hal=kotaedit&id=<?php echo $data['id_kota']; ?>"><img src="../img/edit.png" /></a>
                <a href="kotahapus.php?id=<?php echo $data['id_kota']; ?>" onclick="return confirm ('Yakin Akan Menghapus Data <?php echo $data ['nama_kota']; ?>')"><img src="../img/hapus.png" /></a>
