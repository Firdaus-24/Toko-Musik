...
$id=$_GET['id'];
$sql=mysql_query("select * from kota where id_kota='$id'");
...
?>
    ...
    <div class="lebar-95persen tinggi-250px kiri garis-atas-1hitam garis-kanan-1hitam garis-kiri-1hitam garis-bawah-1hitam rounded-atas-kanan-1 rounded-atas-kiri-1 rounded-bawah-kanan-1 rounded-bawah-kiri-1 jarak-kiri-2persen jarak-atas-1persen hitam">
       ...
       <form action="kotaupdate.php" method="post" id="tambah">     
      ...
      <table width="40%"  cellpadding="2" cellspacing="2" class="jarak-atas-1persen jarak-kiri-35persen kiri  font-putih font-besar font-bold">
        <input type="hidden" name="id" value="<?php echo $tampil['id_kota'] ?>">
        	<tr>
            	<td>Nama kota</td>
                <td bgcolor=""><input type="text" name="namakota" value="<?php echo $tampil['nama_kota'] ?>" /></td>
            </tr>
            <td>ongkos kirim</td>
                <td><input type="text" name="ongkoskrim" value="<?php echo $tampil['ongkos_kirim'] ?>"/></td>
             </tr>
              <tr>     
                   	<td colspan="2"><input type="submit" value="update kota" 
